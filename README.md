...
<pre> ```bash git clone https://github.com/longlive-pandas/FDS_Kaggle_Competition.git ``` </pre>
...
<pre> ```toml dependencies = [ "ipykernel>=7.0.0", "ipywidgets>=8.1.7", "pandas>=2.3.3", "scikit-learn>=1.7.2", "tqdm>=4.67.1", ] ``` </pre>
